...
def process_song_data(spark, input_data, output_data):
    """
        ...
        after that you should loaded back to S3. 
...
def process_log_data(spark, input_data, output_data):
     """
        ...
        after that you should loaded back to S3. Also output from previous function is used in by spark.read.json command
